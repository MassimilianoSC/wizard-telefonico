...
## Stato attuale
**Fase 1 completata.** Scaffold creato e versionato su GitHub (privato). Il
motore prezzi pizzeria gira e supera i test in locale, **senza** telefonia né
Gemini. Prossimo passo: Fase 2 (telefonia), che richiede config cloud (numero
Twilio + Gemini abilitato).
